#-----Description----------------------------------------------------#
#
#  REGULAR EXPRESSION TESTER, Mk 2 (April 2017)
#
...
If 'dotall' is enabled then a '.' in a regular expression matches a newline character.
...
search_text.tag_configure('highlight', foreground="#FF0000")
...
def find_matches(event = None):
    ...
    except Exception, exception_type: 
